...
import net.endhq.remoteentities.api.thinking.selectors.EntitySelectorViewable;
import net.endhq.remoteentities.persistence.ParameterData;
import net.endhq.remoteentities.persistence.SerializeAs;
import net.endhq.remoteentities.utilities.*;
...
public class DesireAvoidSpecific extends DesireBase
{
	...
	public boolean shouldExecute()
	{
		...
		Vec3D var2 = net.endhq.remoteentities.nms.RandomPositionGenerator.b(this.getEntityHandle(), 16, 7, Vec3D.a(this.m_closestEntity.locX, this.m_closestEntity.locY, this.m_closestEntity.locZ));
