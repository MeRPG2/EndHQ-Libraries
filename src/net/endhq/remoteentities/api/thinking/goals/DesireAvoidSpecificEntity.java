...
public class DesireAvoidSpecificEntity extends DesireBase implements OneTimeDesire
{
	...
	public boolean shouldExecute()
	{
		...
		{
			Vec3D var2 = net.endhq.remoteentities.nms.RandomPositionGenerator.b(this.getEntityHandle(), 16, 7, Vec3D.a(this.m_entityToAvoid.locX, this.m_entityToAvoid.locY, this.m_entityToAvoid.locZ));
