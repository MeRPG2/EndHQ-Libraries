...
import net.endhq.remoteentities.api.events.RemoteEntityCreateEvent;
import net.endhq.remoteentities.exceptions.NoNameException;
import net.endhq.remoteentities.persistence.EntityData;
import net.endhq.remoteentities.persistence.IEntitySerializer;
...
public class EntityManager
{
	...
	{
		Bukkit.getPluginManager().registerEvents(this.m_entityChunkLoader, BukkitPlugin.getInst());
