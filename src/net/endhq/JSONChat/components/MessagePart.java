...
/**
 * Internal class: Represents a component of a JSON-serializable {@link JSONMessage}.
 */
final class MessagePart implements JsonRepresentedObject, ConfigurationSerializable, Cloneable {
	...
	public MessagePart clone() throws CloneNotSupportedException{
		...
		}else if(hoverActionData instanceof JSONMessage){
			obj.hoverActionData = ((JSONMessage)hoverActionData).clone();
		}
		return obj;
