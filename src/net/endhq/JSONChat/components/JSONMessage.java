package net.endhq.JSONChat.components;
...
import static net.endhq.JSONChat.components.TextualComponent.rawText;
import net.endhq.JSONChat.util.ArrayWrapper;
import net.endhq.JSONChat.util.Reflection;
...
public class JSONMessage implements JsonRepresentedObject, Cloneable, Iterable<MessagePart>, ConfigurationSerializable {
	...
	public JSONMessage(final TextualComponent firstPartText) {
