...
public class BehaviorData implements ConfigurationSerializable
{
	...
	public Behavior create(RemoteEntity inEntity)
	{
		...
		{
			BukkitPlugin.getInst().getLogger().warning("Error when trying to deserialize behavior with type " + this.type + ": ");
			BukkitPlugin.getInst().getLogger().warning(e.getMessage());
			return null;
		}
	}
